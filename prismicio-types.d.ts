...
/**
 * Primary content in *CanSkyDive → Default → Primary*
 */
export interface CanSkyDiveSliceDefaultPrimary {
  /**
   * Sentence field in *CanSkyDive → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: can_sky_dive.default.primary.sentence
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  sentence: prismic.KeyTextField;

  /**
   * Flavor field in *CanSkyDive → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: lemonLime
   * - **API ID Path**: can_sky_dive.default.primary.flavor
...
/**
 * Default variation for CanSkyDive Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CanSkyDiveSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<CanSkyDiveSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *CanSkyDive*
 */
type CanSkyDiveSliceVariation = CanSkyDiveSliceDefault;

/**
 * CanSkyDive Shared Slice
 *
 * - **API ID**: `can_sky_dive`
 * - **Description**: CanSkyDive
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type CanSkyDiveSlice = prismic.SharedSlice<
  "can_sky_dive",
  CanSkyDiveSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      BigTextSliceDefault,
      CanSkyDiveSlice,
      CanSkyDiveSliceDefaultPrimary,
      CanSkyDiveSliceVariation,
      CanSkyDiveSliceDefault,
      CarouselSlice,
